  ...
  return (
    <View style={styles.container}>
      <ScrollView>
        ...
        <FlatList data={queueFilteretdTasks} renderItem={renderItem} ListHeaderComponent ={TopTaskItem} />
        <TouchableOpacity style={styles.button} onPress={() => AddTask()}>
          <Text style={styles.buttonText}>Добавить задачу </Text>
        </TouchableOpacity>
        <Text style={[styles.text, {}]}>Мои задачи на приемке</Text>
        <Filter />
        <FlatList data={aprooveTasks} renderItem={renderItemApruve} ListHeaderComponent ={TopTaskApruve}/>
      </ScrollView>
    </View>
  );
}
